...
class Lot(BaseModel):
    ...
    def can_generate_coa(self):
        ...
        return (
            self.generate_coa
            and self.status
            in [LotStatus.TESTED, LotStatus.APPROVED, LotStatus.RELEASED]
            and all(tr.status == "approved" for tr in self.test_results)
        )
    ...
    def update_status(self, new_status):
        ...
        # Valid transitions
        valid_transitions = {
            LotStatus.PENDING: [LotStatus.TESTED, LotStatus.REJECTED],
            LotStatus.TESTED: [LotStatus.APPROVED, LotStatus.REJECTED],
