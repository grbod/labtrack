...
from src.services.coa_generator_service import COAGeneratorService
from src.models import LotStatus, TestResultStatus, COAHistory
...
class TestCOAGeneration:
    ...
    def test_batch_coa_generation(self, test_db, approved_lot, tmp_path, monkeypatch):
        ...
        from src.models import Lot, LotProduct
