...
class TestLotService:
    ...
    def test_create_sublots(self, test_db, sample_product):
        ...
        sublots = service.create_sublots(
            test_db, parent_lot_id=parent.id, count=3, quantity_per_sublot=1000.0
        )
...
class TestApprovalService:
    ...
    def test_lot_auto_approval(
        ...
        """Test that lot status updates when all tests approved."""
        service = ApprovalService()
        ...
        assert sample_lot.status == LotStatus.APPROVED
